...
- Payment / Gebühren section may show: item price, Versand (buyer shipping), Verkaufsgebühr (selling fee), Anzeigengebühr / Werbekosten (ad / promoted listing fee), Versandetikett (seller shipping label you paid), and Auszahlung / Bestelleinnahmen / Sie erhalten (net payout)
...
- buyerShippingEur: Versand / shipping the buyer paid (if shown). null if not visible. Do not invent. Never copy Versandetikett here.
...
- shippingLabelEur: Seller shipping label you paid ("Versandetikett", "Shipping label", "Label"). Absolute EUR amount as a positive number. This is NOT buyer Versand. null if not visible. Do not invent.
- amountReceivedNetEur: What the **seller actually receives** after fees ("Bestelleinnahmen", "Auszahlungsbetrag", "Sie erhalten", "Auszahlung"). Informational only — do NOT confuse this with soldPriceExShippingEur. null if not visible.
