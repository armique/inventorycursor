...
export interface InventoryItem {
  ...
  /** Original packaging / box (OVP). Used by AI description + product card generators. */
  hasOVP?: boolean;
  /** IO Shield / IO-Blende included (motherboards / bundles). Used by AI description + product card generators. */
  hasIOShield?: boolean;
