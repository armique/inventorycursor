...
const StorefrontPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 py-8 sm:py-10 flex gap-8 flex-1">
        ...
        <main className="flex-1 min-w-0">
          ...
          {showNoResults && (
            <div className={`flex flex-col items-center justify-center py-24 text-center rounded-2xl border p-8 ${
              ...
              <button type="button" onClick={handleClearFilters} className="mt-6 px-5 py-2.5 rounded-xl bg-brand-600 text-white text-sm font-bold hover:bg-brand-700">
                {TEXTS.clearFilters}
              </button>
            </div>
          )}
