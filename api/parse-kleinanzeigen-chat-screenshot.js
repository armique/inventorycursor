/**
 * Vercel serverless: parse Kleinanzeigen chat screenshot with Gemini (vision).
 */
import {
...
export default async function handler(req, res) {
  ...
  const geminiBody = {
    contents: [
      {
        parts: [
          { text: KLEINANZEIGEN_CHAT_SCREENSHOT_EXTRACTION_PROMPT },
  ...
  try {
    ...
    console.error('parse-kleinanzeigen-chat-screenshot', e);
